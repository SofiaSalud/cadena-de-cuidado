CREATE OR REPLACE TABLE `sofia-data-305018.cadena_cuidado.acute_services_events_diseases_socios` AS 
...
WITH
  ...
  base AS (
		SELECT DISTINCT
            ...
            emr.signed,
            emr.doctor_specializations AS emr_doctor_specializations,
            emr.doctor_specializations_description AS emr_doctor_specializations_description,
            emr.doctor_specializations_type AS emr_doctor_specializations_type,
            emr.doctor_specializations_is_primary_care AS emr_doctor_specializations_is_primary_care,
...
SELECT
  member_id,
	...
	signed,
    emr_doctor_specializations,
    emr_doctor_specializations_description,
    emr_doctor_specializations_type,
    emr_doctor_specializations_is_primary_care,
